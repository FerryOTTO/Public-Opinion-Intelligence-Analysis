...
import WorldHeatMap from '@/components/Charts/WorldHeatMap.vue'
      ...
      <div class="right-col-wrap">
        ...
        <div class="tech-card spatiotemporal-panel">
          ...
          <div class="st-layout">
            <!-- 地图 -->
            <div class="st-map">
              <div class="st-map-title">🌐 全球空间分布 — {{ selectedHour }}:00 数据采集热区</div>
              <WorldHeatMap :data="globeNodes.map((item) => ({ name: item.name, value: item.value }))" />
            </div>
            <!-- 时间轴 -->
            <div class="st-time">
